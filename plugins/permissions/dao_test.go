...
func TestCreatePermission(t *testing.T) {
	fmt.Println("TESTING PERMISSION GOT CALLED")
	t.Run("createPermissionTest", func(t *testing.T) {
		es, _ := newStubClient("", ".permissions", "mapping")
		_, err := es.postPermission(context.Background(), permission.Permission{
		...
		fmt.Println("PERMISSION GOT CREATED")
