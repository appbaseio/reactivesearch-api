...
type Query struct {
	...
	FieldWeights                []float64                   `json:"fieldWeights,omitempty" jsonschema:"title=fieldWeights,description=(deprecated) weights of the data fields" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	...
	SortField                   *string                     `json:"sortField,omitempty" jsonschema:"title=sortField,description=field(s) to run the sorting on" jsonschema_extras:"engine=elasticsearch,engine=solr,engine=opensearch"`
	...
	CustomHighlight             *map[string]interface{}     `json:"customHighlight,omitempty" jsonschema:"title=customHighlight,description=(deprecated) same as highlightConfig" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	...
	RankFeature                 *map[string]RankFunction    `json:"rankFeature,omitempty" jsonschema:"title=rankFeature,description=boost relevant score of documents based on rank_feature fields" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	DistinctField               *string                     `json:"distinctField,omitempty" jsonschema:"title=distinctField,description=returns only distinct value documents for the specified field" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	DistinctFieldConfig         *map[string]interface{}     `json:"distinctFieldConfig,omitempty" jsonschema:"title=distinctFieldConfig,description=additional options to the distinctField property" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	...
	EnableRecentSuggestions     *bool                       `json:"enableRecentSuggestions,omitempty" jsonschema:"title=enableRecentSuggestions,description=whether or not to enable recent suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	RecentSuggestionsConfig     *RecentSuggestionsOptions   `json:"recentSuggestionsConfig,omitempty" jsonschema:"title=recentSuggestionsConfig,description=additional options for getting recent suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	...
	PopularSuggestionsConfig    *PopularSuggestionsOptions  `json:"popularSuggestionsConfig,omitempty" jsonschema:"title=popularSuggestionsConfig,description=additional options for getting popular suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	ShowDistinctSuggestions     *bool                       `json:"showDistinctSuggestions,omitempty" jsonschema:"title=showDistinctSuggestions,description=whether or not to show distinct suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	EnablePredictiveSuggestions *bool                       `json:"enablePredictiveSuggestions,omitempty" jsonschema:"title=enablePredictiveSuggestions,description=predicts the next relevant words from the value of a field based on the search query typed by the user" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	MaxPredictedWords           *int                        `json:"maxPredictedWords,omitempty" jsonschema:"title=maxPredictedWords,description=specify the the maximum number of relevant words that are predicted" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	URLField                    *string                     `json:"urlField,omitempty" jsonschema:"title=urlField,description=convenience prop that allows returning the URL value in the suggestion's response" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	ApplyStopwords              *bool                       `json:"applyStopwords,omitempty" jsonschema:"title=applyStopwords,description=whether or not predict a suggestion which starts or ends with a stopword" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	Stopwords                   *[]string                   `json:"customStopwords,omitempty" jsonschema:"title=customStopwords,description=list of custom stopwords" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	SearchLanguage              *string                     `json:"searchLanguage,omitempty" jsonschema:"title=searchLanguage,description=used to apply language specific stopwords for predictive suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	CalendarInterval            *string                     `json:"calendarinterval,omitempty" jsonschema:"title=calendarInterval,description=set the histogram bar interval when range value is of type date" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	Script                      *string                     `json:"script,omitempty" jsonschema:"title=script,description=indicates the script to run while reordering the results" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	QueryVector                 *[]float64                  `json:"queryVector,omitempty" jsonschema:"title=queryVector,description=specify a vector to match for the reordering the results using kNN" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	VectorDataField             *string                     `json:"vectorDataField,omitempty" jsonschema:"title=vectorDataField,description=field in the index to be used to reorder the results using kNN" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	Candidates                  *int                        `json:"candidates,omitempty" jsonschema:"title=candidates,description=indicates the number of candidates to consider while using the script_score functionality to reorder the results using kNN" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=opensearch"`
	EnableFeaturedSuggestions   *bool                       `json:"enableFeaturedSuggestions,omitempty" jsonschema:"title=enableFeaturedSuggestions,description=whether or not to enable featured suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	FeaturedSuggestionsConfig   *FeaturedSuggestionsOptions `json:"featuredSuggestionsConfig,omitempty" jsonschema:"title=featuredSuggestionsConfig,description=additional options to specify for featured suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	EnableIndexSuggestions      *bool                       `json:"enableIndexSuggestions,omitempty" jsonschema:"title=enableIndexSuggestions,description=whether or not to enable index suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
	IndexSuggestionsConfig      *IndexSuggestionsOptions    `json:"indexSuggestionsConfig,omitempty" jsonschema:"title=indexSuggestionsConfig,description=additional options to specify for index suggestions" jsonschema_extras:"engine=elasticsearch,engine=mongodb,engine=solr,engine=opensearch"`
