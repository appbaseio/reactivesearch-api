...
func (m *mockES) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESIndicesByAliasErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESMappingsOfErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESSettingsOfErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESAliasesOfErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESCreateIndexErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESDeleteIndexErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
...
func (m *mockESSetAliasErr) reindex(ctx context.Context, esService reindexService, index string, body *reindexConfig, waitForCompletion bool) ([]byte, error) {
	return nil, nil
}
